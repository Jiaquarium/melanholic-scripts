...
public class Script_PuzzlesEventsManager : MonoBehaviour
{
    ...
    public static void PuzzleProgress()
    {
        if (OnPuzzleProgress != null) OnPuzzleProgress();
    }
    ...
    public static void PuzzleProgress2()
    {
        if (OnPuzzleProgress2 != null) OnPuzzleProgress2();
    }
    ...
    public static void PuzzleReset()
    {
        if (OnPuzzleReset != null) OnPuzzleReset();
    }

    public delegate void ClearDoorwaysAction();
    public static event ClearDoorwaysAction OnClearDoorways;
    public static void ClearDoorways()
    {
        if (OnClearDoorways != null)    OnClearDoorways();
    }
}
