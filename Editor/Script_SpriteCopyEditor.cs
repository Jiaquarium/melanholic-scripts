...
public class Script_SpriteCopyEditor : EditorWindow {
    ...
    static void Init()
    {
        ...
        Script_SpriteCopyEditor window = (Script_SpriteCopyEditor)EditorWindow.GetWindow (typeof (Script_SpriteCopyEditor));
        window.Show();
    }
